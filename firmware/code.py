...
keyboard.col_pins = (
    ...
    board.GP7, board.GP8, board.GP9, board.GP12, board.GP13, board.GP14, board.GP15,
...
base_layer = [
    ...
    KC.LCTL, KC.LGUI, KC.LALT, KC.NO, KC.NO, KC.NO, KC.SPC, KC.NO, KC.NO, KC.NO, KC.RALT, KC.RGUI, KC.MO(1), KC.RCTL, KC.LEFT, KC.DOWN, KC.RIGHT,
]
...
fn_layer = [KC.RESET, KC.NO, KC.BOOTLOADER, KC.NO, KC.NO, KC.NO, KC.MPLY, KC.MSTP, KC.MPRV, KC.MNXT, KC.NO, KC.MUTE, KC.VOLD, KC.VOLU] + [KC.NO]*83
